...
async fn test_save_and_count_prices() {
    ...
    let price = common::create_test_price("p01-c1", 1.50, 3.00);
...
async fn test_save_prices_upsert() {
    ...
    let price1 = common::create_test_price("p02-c1", 1.50, 3.00);
    price_repo.save_prices(&[price1]).await.unwrap();

    // Same card+date — should upsert
    let price2 = common::create_test_price("p02-c1", 2.00, 4.00);
...
async fn test_save_price_history() {
    ...
    let price = common::create_test_price("p03-c1", 1.50, 3.00);
...
async fn test_fetch_prices_for_card_ids() {
    ...
    let price = common::create_test_price("p05-c1", 1.50, 3.00);
    price_repo.save_prices(&[price]).await.unwrap();
